...
urlpatterns = patterns('',
    ...
    url(r'^party/scenes/(?P<party_id>\d+)$', 'party.views.scenes'),
    url(r'^party/characters/(?P<party_id>\d+)$', 'party.views.characters'),
    url(r'^party/add_scene/(?P<party_id>\d+)$', 'party.views.add_scene'),
    url(r'^scene/(?P<scene_id>\d+)$', 'party.views.view_scene'),
    url(r'^character/(?P<character_id>\d+)$', 'party.views.view_character'),
    url(r'^character/edit/(?P<character_id>\d+)$', 'party.views.edit_character'),
